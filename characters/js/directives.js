...
directives.characterTable = function($rootScope, $timeout, $compile, $storage) {
    return {
        ...
        link: function(scope, element, attrs) {
            ...
            // fuzzy toggle
            var fuzzyToggle = $('<label class="fuzzy-toggle"><input type="checkbox">Habilitar búsqueda especial</input></label>');
            fuzzyToggle.attr('title','Cuando está activado, las búsquedas también mostrarán unidades cuyo nombre no coincida exactamente con las palabras claves de búsqueda. \nEs útil si no sabe la forma correcta de escribir una cierta unidad.');
