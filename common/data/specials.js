window.specials = {
	...
	637: {
		...
		type: "condition",
		warning: "El especial seleccionado (%name%) asume que el enemigo tiene el bufo de defensa activo."
	},
	642: {
	...
	668: {
		...
		onActivation: function(p) {
			...
			p.scope.notify({
				text: 'Usando el multiplicador de ATK ' + [1.5, 2][n] + 'x. Para cambiar al multiplicador ' + [2, 1.5][n] + 'x, desactiva y vuelve a activar este especial.',
				name: '667warning'
			});
		}
	},
	...
	719: {
		...
		onActivation: function(p) {
			...
			p.scope.notify({
				text: 'HP ' + (n == 2 ? 'por debajo' : 'por encima') + ' 30%, se usa el multiplicador ' + n + 'x.',
				name: '719warning'
			});
		}
	},
	...
	780: {
		...
		onActivation: function(p) {
			...
			p.scope.notify({
				text: 'Se usa el multiplicador ' + n + 'x.',
				name: '780warning'
			});
		}
	},
		...
		onActivation: function(p) {
			...
			p.scope.notify({
				text: (window.specials[843].multiplier ?
					'Potenciando Shooters. Para cambiar al segundo multiplicador, desactiva y vuelve a activar este especial.' :
					'Potenciando Shooters, Slashers y Strikers. Para cambiar al primer multiplicador, desactiva y vuelve a activar este especial.'),
				name: '843warning'
			});
		}
	},
		...
		onActivation: function(p) {
			...
			p.scope.notify({
				text: (window.specials[844].multiplier ?
					'Potenciando Shooters. Para cambiar al segundo multiplicador, desactiva y vuelve a activar este especial.' :
					'Potenciando Shooters, Slashers and Strikers. Para cambiar al primer multiplicador, desactiva y vuelve a activar este especial.'),
				name: '844warning'
			});
		}
	},
		...
		onActivation: function(p) {
			...
			p.scope.notify({
				text: (window.specials[873].first ?
					'Activando la primera carga. Para cambiar a la segunda carga, desactiva y vuelve a activar este especial.' :
					'Activando la segunda carga. Para cambiar a la primera carga, desactiva y vuelve a activar este especial.'),
				name: '873warning'
			});
		}
	},
	...
	905: {
		...
		onActivation: function(p) {
			...
			p.scope.notify({
				text: 'Activando carga #' + (window.specials[905].stage + 1) + '. Para pasar a la siguiente carga, desactiva y vuelve a activar este especial.',
				name: '905warning'
			});
		}
	},
	906: {
		...
		onActivation: function(p) {
			...
			p.scope.notify({
				text: 'Activando carga #' + (window.specials[906].stage + 1) + '. Para pasar a la siguiente carga, desactiva y vuelve a activar este especial.',
				name: '906warning'
			});
		}
	},
	...
	911: {
		...
		onActivation: function(p) {
			...
			p.scope.notify({
				text: 'Activando carga #' + (window.specials[911].stage + 1) + '. Para pasar a la siguiente carga, desactiva y vuelve a activar este especial.',
				name: '911warning'
			});
		}
	},
	912: {
		...
		onActivation: function(p) {
			...
			p.scope.notify({
				text: 'Activando carga #' + (window.specials[912].stage + 1) + '. Para pasar a la siguiente carga, desactiva y vuelve a activar este especial.',
				name: '912warning'
			});
		}
	},
